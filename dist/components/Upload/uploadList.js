...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "mo-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "mo-upload-list-item", key: item.uid },
